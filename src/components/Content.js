                ...
                <div id="carouselExampleSlidesOnly" className='carousel slide' data-ride="carousel">
                    <div className='carousel-inner'>
                        <div className='carousel-item active'>
                            <img className='d-block w-100' src="images/slide_001-6.jpg" alt="First slide"
                            style={{height:"auto"}}/>
                        </div>
                        <div class="carousel-item ">
                     <img class="d-block w-100 " src="images/tours_slide_tregole_9-768x403.jpg" alt="Second slide" style={{height:"auto"}}/>
                  </div>
                  <div class="carousel-item">
                     <img class="d-block w-100" src="images/banners-3.jpg" alt="Third slide" style={{height:"auto"}}/>
                  </div>
                    </div>
                </div>
            </section>
                ...
                <div className='row'>
                    <div className='col-sm-4 mb-5'>
                        <div className='card mt-4'>
                            <img className='card-img-top' src='images/destination1.jpg' alt="card-image1"/>
                            <div className='card-body'>
                                <h4 className='card-title text-secondary'>London</h4>
                    ...
                    <div className='col-sm-4 mb-5'>
                        <div className='card mt-4'>
                            <img className='card-img-top' src='images/destination2.jpg' alt="card-image2"/>
                            <div className='card-body'>
                    ...
                    <div className='col-sm-4 mb-5'>
                        <div className='card mt-4'>
                        <img className='card-img-top' src='images/dest3.jpg' alt="card-image3"/>
                            <div className='card-body'>
            ...
            <section id="places">
                <div className='container'>
                    <div className='col-sm-12 col-md-12 mb-4'>
                        <h3 className='text-center mt-4 text-secondary'>Places and Description</h3>
                    </div>
